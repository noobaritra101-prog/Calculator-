...
HOUSE_EDGE_PCT = 0.05            # 5% house edge
TICK_INTERVAL = 0.05             # Multiplier update rate (50ms)
GROWTH_RATE = 0.00006            # Multiplier growth speed
MIN_BET = 10
MAX_BET = 10_000
MAX_CRASH_POINT = 1000.0         # Safety ceiling
ROUND_HISTORY_LIMIT = 50         # History size
...
async def play_aviator_cmd(message: Message):
    ...
    # Netlify hosted frontend URL
    netlify_url = "https://moonlit-mooncake-0b463e.netlify.app/"
    ...
    await message.reply(
        "<b>「 ✈️ AVIATOR CRASH GAME 」</b>\n"
        "━━━━━━━━━━━━━━━━━\n"
        "Place your bets, watch the multiplier climb, and cash out before the plane flies away!\n\n"
...
async def get_weblog_cmd(message: Message):
    """Returns raw diagnostic logs to administrators."""
